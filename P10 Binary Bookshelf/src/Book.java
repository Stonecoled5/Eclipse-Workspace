...
/////////////////////////////////////////////////////////////////////////////// 
/**
 * An instantiable class representing information about a Book for our
 * LinkedBookshelf project.
 * 
 * @author hobbes and Cole Johnstone
 *
 */
public class Book {
	...
	/**
	 * A nonstandard compareTo - based on the attribute argument, returns a
	 * comparison of this Book to otherBook based on one of four possible pieces of
	 * data.
	 * 
	 * @param otherBook the Book to compare this one to
	 * @param a         the attribute on which to compare them
	 * @return negative if this Book is greater than otherBook, positive if less
	 *         than otherBook, 0 if equal.
	 */
	...
	/**
	 * Resets the ID generator for testing purposes. Call this method at the
	 * beginning of every test method you write to assure that all Book ID numbers
	 * begin from 0 again.
	 */
	...
	/**
	 * Determines if two books are equal to each other
	 * 
	 * @param other
	 * @return boolean
	 */
	...
	public boolean equals(Object o) {
		if (o instanceof Book)
			if (this.compareTo((Book) o, Attribute.ID) == 0)
				if (this.compareTo((Book) o, Attribute.TITLE) == 0)
					if (this.compareTo((Book) o, Attribute.AUTHOR) == 0)
						if (this.compareTo((Book) o, Attribute.PAGECOUNT) == 0) {
							return true;
						}
		return false;
	}
