...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
	...
	/**
	 * Resolves any red node with red parent property violations that are introduced
	 * by inserting new nodes into a red-black tree. While doing so, all other
	 * red-black tree properties are also preserved
	 * 
	 * @param redNode
	 */
			...
			if (node.parent.blackHeight == 0) {
				if (node.parent.isLeftChild()) {
					if (node.parent.parent.rightChild != null) {
						if (node.parent.parent.rightChild.blackHeight == 1) {
						...
						if (node.parent.parent.rightChild.blackHeight == 0) {
				...
				if (node.parent.isRightChild()) {
					if (node.parent.parent.leftChild != null) {
						if (node.parent.parent.leftChild.blackHeight == 1) {
							if (node.isLeftChild()) {
								rotate(node, node.parent);
								rotate(node.parent, node.parent.parent);
								node.blackHeight = 1;
						...
						if (node.parent.parent.leftChild.blackHeight == 0) {
							node.parent.parent.blackHeight = 0;
							node.parent.blackHeight = 1;
	...
	/**
	 * First create a subtree we will use in each high level case test
	 */
	@BeforeEach
	...
	/**
	 * This test method checks if the tree validity method correctly handles an
	 * insert of a right child node on a left child of a left child with no right
	 * child in a subtree
	 * 
	 */
	@Test
	public void test1() {
		...
		String correct = "level order: [ 50, 30, 70, 10, 40, 60, 90 ]/nin order: [ 10, 30, 40, 50, 60, 70, 90 ]";
	...
	/**
	 * This test method checks if the tree validity method correctly handles an
	 * insert of a right child node on a red right child of a black right child with
	 * a red left Child
	 * 
	 */
	@Test
	public void test2() {
		tree.insert(100);
		String string = tree.toString();
		String correct = "level order: [ 50, 40, 70, 10, 60, 90, 100 ]/nin order: [ 10, 40, 50, 60, 70, 90, 100 ]";
		if (!string.equals(correct)) {
			System.out.println(string);
			System.out.println(correct);
	...
	/**
	 * This test method tests if the tree validity method correctly handles an
	 * insert of a left child of a red left child of a black left child with no
	 * right child
	 * 
	 */
	@Test
	public void test3() {
		tree.insert(0);
		String string = tree.toString();
		String correct = "level order: [ 50, 10, 70, 0, 40, 60, 90 ]/nin order: [ 0, 10, 40, 50, 60, 70, 90 ]";
		if (!string.equals(correct)) {
			System.out.println(string);
			System.out.println(correct);
